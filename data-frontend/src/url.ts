/**
 * @file This file contains `runtypes` -specific code on defining URL path portion for invoking endpoints on frontend side.
 */

import type * as protocol from "@ty-ras/protocol";
import type * as data from "@ty-ras/data";
import * as dataIO from "@ty-ras/data-runtypes";
 ...
 * @param encoder The runtime validation of URL path parameter, as `runtypes` object.
